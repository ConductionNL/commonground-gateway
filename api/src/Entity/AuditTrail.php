...
#[
    ApiResource(
        ...
        operations: [
            new Get("/admin/audit_trails/{id}"),
            new Put("/admin/audit_trails/{id}"),
            new Delete("/admin/audit_trails/{id}"),
            new GetCollection("/admin/audit_trails"),
            new Post("/admin/audit_trails")
        ],
