...
/**
 * Thiis handler provides the functionality for combing an endpoitn with the datalayer
 */
class EdnpointHandler implements ActionHandlerInterface
{
    ...
    /**
     * This function runs the endpoint handling logic plugin.
     *
