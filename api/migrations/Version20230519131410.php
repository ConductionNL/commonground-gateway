 ...
 */
final class Version20230519131410 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE value_coupler (value_id UUID NOT NULL, coupler_id UUID NOT NULL, PRIMARY KEY(value_id, coupler_id))');
        $this->addSql('CREATE INDEX IDX_8873337CF920BBA2 ON value_coupler (value_id)');
        $this->addSql('CREATE INDEX IDX_8873337C248A9586 ON value_coupler (coupler_id)');
        $this->addSql('ALTER TABLE value_coupler ADD CONSTRAINT FK_8873337CF920BBA2 FOREIGN KEY (value_id) REFERENCES value (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE value_coupler ADD CONSTRAINT FK_8873337C248A9586 FOREIGN KEY (coupler_id) REFERENCES coupler (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('DROP TABLE coupler_value');
        ...
        $this->addSql('ALTER TABLE coupler ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE coupler ALTER id DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupler_value (coupler_id UUID NOT NULL, value_id UUID NOT NULL, PRIMARY KEY(coupler_id, value_id))');
        $this->addSql('CREATE INDEX idx_e0917024f920bba2 ON coupler_value (value_id)');
        $this->addSql('CREATE INDEX idx_e0917024248a9586 ON coupler_value (coupler_id)');
        $this->addSql('ALTER TABLE coupler_value ADD CONSTRAINT fk_e0917024248a9586 FOREIGN KEY (coupler_id) REFERENCES coupler (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE coupler_value ADD CONSTRAINT fk_e0917024f920bba2 FOREIGN KEY (value_id) REFERENCES value (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('DROP TABLE value_coupler');
        $this->addSql('ALTER TABLE authentication ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE authentication ALTER id DROP DEFAULT');
        $this->addSql('ALTER TABLE action_handler ALTER id TYPE UUID');
        $this->addSql('ALTER TABLE action_handler ALTER id DROP DEFAULT');
