 ...
 */
final class Version20230519110104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupler (id UUID NOT NULL, object_id VARCHAR(255) NOT NULL, entity VARCHAR(255) NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, date_modified TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE gateway_audit_trail ALTER amendments DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coupler_value DROP CONSTRAINT FK_E0917024248A9586');
        $this->addSql('DROP TABLE coupler');
